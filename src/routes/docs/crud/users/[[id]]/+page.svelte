<script lang="ts">
	...
	import CrudForm from '$lib/examples/crud/CrudForm.svelte';
...
<div class="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-9">
	...
	>
		<h2 class="text-3xl font-semibold">CRUD Superform</h2>
		<p class="text-muted-foreground">
			An example of a CRUD form using Superform. This form is used to create and update users.
		</p>
