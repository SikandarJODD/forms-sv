<script lang="ts">
	...
	import ImageValidation from '$lib/examples/image-validation/ImageValidation.svelte';
...
<div class="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-9">
	...
	>
		<h2 class="text-3xl font-semibold">Image Validation</h2>
		<p class="text-muted-foreground">
			Simple Example of Image Validation include Image Size, Image Type
		</p>
